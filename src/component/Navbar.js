    ...
    <>
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
            <div className="container-fluid">
                <a className="navbar-brand px-5" href="/">Text-Utils</a>
                ...
                <div className={`form-check form-switch px-5 text-${props.mode === 'light'?'dark':'light'}`}>
                    <input className="form-check-input" onClick={props.setMode} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
